...
<div class="main-content">
    <div class="wrapper">
        ...
        if(isset($_GET['id']))
        {
            //get theb order detils
            $id=$_GET['id'];

            //sql query to get all datas from table
                ...
                <tr>
                    ...
                    <td>
                        <select name="status" id="">
                            ...
                            <option <?php if($status=="On Delivery"){echo "selected";} ?>  value="On Delivery"> On Delviery</option>
        ...
        <?php
            ...
            //check weather update button clicked or not
            if(isset($_POST['submit']))
            {
                ...
                {
                    //not updated
                    $_SESSION['update']="<div class='sucess'>Fail TO updated Order</div>";
                    header('location:'.HOME.'admin/manage-order.php');
